...
static void lastheard_prch(void* p, char c) { lastheard_putch(c); }
...
void lastheard_redraw() { lastheard_redraw_flag = 1; }
...
static void slog_prch(void* p, char c) { slog_putch(c); }
...
void slog_redraw() { slog_redraw_flag = 1; }
...
static void clog_prch(void* p, char c) { clog_putch(c); }
...
void clog_redraw() { clog_redraw_flag = 1; }
