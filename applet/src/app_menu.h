...
#define AM_RESULT_OCCUPY_SCREEN                                                                                        \
    16 // for APPMENU_EVT_ENTER and APPMENU_EVT_PAINT:
...
#define AM_RESULT_EXIT_AND_RELEASE_SCREEN                                                                              \
    17 // returned by menu callback
...
#define SEL_FLAG_CURRENT                                                                                               \
    2 // same combination of colours for the currently
...
typedef struct tAppMenuItem { // Describes a single menu item ("line"). Located in Flash (ROM),
...
#define APPMENU_OPT_BACK                                                                                               \
    255 // "back to the parent menu or the main screen"
...
#define APPMENU_EVT_PAINT                                                                                              \
    0 // this menu item is just about to be 'painted'.
...
#define APPMENU_EVT_GET_VALUE                                                                                          \
    1 // let the callback function provide the 'display' value.
      ...
      //
#define APPMENU_EVT_ENTER                                                                                              \
    2                            // operator has pressed ENTER while this item was focused.
...
#define APPMENU_EVT_END_EDIT                                                                                           \
    6                     // stopped editing (just an "info", there's no way to intercept "end of editing")
