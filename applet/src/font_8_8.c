...
/* Later modified by DL4YHF for applet/src/font_8_8.c .   */
/*--------------------------------------------------------*/

const unsigned char font_8_8[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x00
    // ex: 0x7e,0x81,0xa5,0x81,0xbd,0x99,0x81,0x7e, // 0x01 = "white smiley"
    // ex: 0x7e,0xff,0xdb,0xff,0xc3,0xe7,0xff,0x7e, // 0x02 = "black smiley"
    // 2017-05-05 : Replaced the above two characters by something more useful: RADIO BUTTONS (~~ Unicode 1F518) !
    // 1 ........ 0x00        ........ 0x00
    // 2 . **** . 0x3C        . **** . 0x3C
    // 3 .*    *. 0x42        .*    *. 0x42
    // 4 .*    *. 0x42        .* ** *. 0x5A     // (not a nice "disk" inside the 8*8 pixel matrix,
    // 5 .*    *. 0x42        .* ** *. 0x5A     //  anyway.. the SELECTED item is also highlighted
    // 6 .*    *. 0x42        .*    *. 0x42     //  with a different colour. See amenu_codeplug.c )
    // 7 . **** . 0x3C        . **** . 0x3C
    // 8 ........ 0x00        ........ 0x00
    0x00, 0x3C, 0x42, 0x42, 0x42, 0x42, 0x3C, 0x00, // 0x01 = "unselected RADIO BUTTON"
    0x00, 0x3C, 0x42, 0x5A, 0x5A, 0x42, 0x3C, 0x00, // 0x02 = "selected RADIO BUTTON" (~~ Unicode 1F518)
    ...
    0x00, 0x80, 0xe0, 0xf8, 0xff, 0xf8, 0xe0,
    0x80, // 0x10 : black triangle pointing right, slightly modified, aligned with horz line (0xC4)
    0x00, 0x02, 0x0e, 0x3e, 0xff, 0x3e, 0x0e,
    0x02, // 0x11 : black triangle pointing left, also modified to align with lines
