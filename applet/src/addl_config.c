...
void cfg_load() {
    ...
    R(global_addl_config.devmode_level,
      3);                                // 2017-06-06	0-off, 1-show FM options, 2-extended USB logging, 3-hide menus
    ...
    R(global_addl_config.chan_stat,
      4); // 2017-08-08	0=off 1=on 2=rx_freq 3=tx_freq 4=rx_tx channel statusline with TS / TG info
