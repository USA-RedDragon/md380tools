...
//---------------------------------------------------------------------------
void IntToBinaryString(int   iValue,    // [in] value to be converted
...
//---------------------------------------------------------------------------
void IntToDecHexBinString(int   iValue,    // [in] value to be converted
...
void Menu_GetColours(int sel_flags, uint16_t* pFgColor, uint16_t* pBgColor) {
    ...
    if (LCD_GetColorDifference(fg_color, bg_color) <
        10) { // difference too small -> discard customized colours to make the menu "readable" again
