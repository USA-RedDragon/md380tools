...
const menu_item_t am_Main[] = { // { "Text__max__13", data_type,  options,opt_value,
                                //     pvValue,iMinValue,iMaxValue, string table, callback }
    {"Chnl", DTYPE_WSTRING, APPMENU_OPT_NONE, 0, channel_name, 0, 0, NULL, NULL},
    {"Zone", DTYPE_WSTRING, APPMENU_OPT_NONE, 0, zone_name, 0, 0, NULL, am_cbk_ZoneList},
    {"Cont", DTYPE_WSTRING, APPMENU_OPT_NONE, 0, contact.name, 0, 0, NULL, NULL},
    ...
    {"TkGrp", DTYPE_INTEGER, APPMENU_OPT_EDITABLE, 0, NULL /*pvValue*/, 0 /*min*/, 0x00FFFFFF /*max:24 bit*/, NULL,
     am_cbk_SetTalkgroup},
    ...
    {"Netmon", DTYPE_NONE, APPMENU_OPT_NONE, 0, NULL, 0, 0, NULL, am_cbk_NetMon},
    {"Exit", DTYPE_NONE, APPMENU_OPT_BACK, 0, NULL, 0, 0, NULL, NULL},
...
const menu_item_t am_Setup[] = // setup menu, nesting level 1 ...
    {                          // { "Text__max__13", data_type,  options,opt_value,
                               //     pvValue,iMinValue,iMaxValue, string table, callback }
        {"Setup:Back", DTYPE_NONE, APPMENU_OPT_BACK, 0, NULL, 0, 0, NULL, NULL},

        // { "Text__max__13", data_type,  options,opt_value,
        //    pvValue,iMinValue,iMaxValue, string table, callback }
        {"[1 Backlight]Level Lo", DTYPE_INTEGER, APPMENU_OPT_EDITABLE | APPMENU_OPT_IMM_UPDATE | APPMENU_OPT_BITMASK_R,
         0x0F, &global_addl_config.backlight_intensities, 0, 9, NULL, NULL},
        {"Level Hi", DTYPE_INTEGER, APPMENU_OPT_EDITABLE | APPMENU_OPT_IMM_UPDATE | APPMENU_OPT_BITMASK_R, 0xF0,
         &global_addl_config.backlight_intensities, 1, 9, NULL, NULL},
        {"Time/sec", DTYPE_UNS8, APPMENU_OPT_EDITABLE | APPMENU_OPT_FACTOR, 5 /*!*/, &md380_radio_config.backlight_time,
         0, 120, NULL, NULL},

        // { "Text__max__13", data_type,  options,opt_value,
        //    pvValue,iMinValue,iMaxValue,           string table, callback }
        {"[2 Morse output]Mode", DTYPE_UNS8, APPMENU_OPT_EDITABLE | APPMENU_OPT_BITMASK,
        ...
        {"Speed/WPM", DTYPE_UNS8, APPMENU_OPT_EDITABLE | APPMENU_OPT_IMM_UPDATE, 0, &global_addl_config.cw_speed_WPM,
         10, 60, NULL, NULL},
        {"Pitch/Hz", DTYPE_UNS8, APPMENU_OPT_EDITABLE | APPMENU_OPT_IMM_UPDATE | APPMENU_OPT_FACTOR, 10,
         &global_addl_config.cw_pitch_10Hz, 200, 2000, NULL, NULL},
        {"Volume", DTYPE_UNS8, APPMENU_OPT_EDITABLE | APPMENU_OPT_IMM_UPDATE, 0, &global_addl_config.cw_volume, 0, 100,
         am_stringtab_255Auto, NULL},
        ...
        {"[3 Colours;h4]Colour Scheme", DTYPE_NONE, APPMENU_OPT_NONE, 0, NULL, 0, 0, NULL, am_cbk_ColorSchemes},
        {"[h4]Foregnd", DTYPE_UNS16, APPMENU_OPT_NONE, 0, &global_addl_config.fg_color, 0, 0, am_stringtab_color_names,
         am_cbk_ColorPicker},
        {"[h4]Backgnd", DTYPE_UNS16, APPMENU_OPT_NONE, 0, &global_addl_config.bg_color, 0, 0, am_stringtab_color_names,
         am_cbk_ColorPicker},
        {"[h4]Sel/nav fg", DTYPE_UNS16, APPMENU_OPT_NONE, 0, &global_addl_config.sel_fg_color, 0, 0,
         am_stringtab_color_names, am_cbk_ColorPicker},
        {"[h4]Sel/nav bg", DTYPE_UNS16, APPMENU_OPT_NONE, 0, &global_addl_config.sel_bg_color, 0, 0,
         am_stringtab_color_names, am_cbk_ColorPicker},
        {"[h4]Editor fg", DTYPE_UNS16, APPMENU_OPT_NONE, 0, &global_addl_config.edit_fg_color, 0, 0,
         am_stringtab_color_names, am_cbk_ColorPicker},
        {"[h4]Editor bg", DTYPE_UNS16, APPMENU_OPT_NONE, 0, &global_addl_config.edit_bg_color, 0, 0,
         am_stringtab_color_names, am_cbk_ColorPicker},

        // { "Text__max__13", data_type,  options,opt_value,
        //     pvValue,iMinValue,iMaxValue, string table, callback }
        {"[4 Test/Debug;h8]HexMon", DTYPE_UNS32, APPMENU_OPT_EDITABLE, 0, &HexMon_u32StartAddress, 0, 0, NULL,
         am_cbk_HexMon},
        {"bl_timer", DTYPE_UNS16, APPMENU_OPT_NONE, 0, &backlight_timer, 0, 0, NULL, NULL},
        {"opmode2", DTYPE_UNS8, APPMENU_OPT_NONE, 0, &gui_opmode2, 0, 0, am_stringtab_opmode2, NULL},
        {"[b8]opmode1", DTYPE_UNS8, APPMENU_OPT_NONE, 0, &gui_opmode1, 0, 0, NULL, NULL},
        {"[b8]opmode3", DTYPE_UNS8, APPMENU_OPT_NONE, 0, &gui_opmode3, 0, 0, NULL, NULL},
        ...
        {"[b8]radio_s0", DTYPE_UNS8, APPMENU_OPT_NONE, 0, &radio_status_1.m0, 0, 0, NULL, NULL},
        {"[b8]radio_s1", DTYPE_UNS8, APPMENU_OPT_NONE, 0, &radio_status_1.m1, 0, 0, NULL, NULL},
        {"[b8]radio_s2", DTYPE_UNS8, APPMENU_OPT_NONE, 0, &radio_status_1.m2, 0, 0, NULL, NULL},
        {"[b8]radio_s3", DTYPE_UNS8, APPMENU_OPT_NONE, 0, &radio_status_1.m3, 0, 0, NULL, NULL},
#endif
        {"Colour test", DTYPE_NONE, APPMENU_OPT_NONE, 0, NULL, 0, 0, NULL, am_cbk_ColorTest},
        {"Setup:Back", DTYPE_NONE, APPMENU_OPT_BACK, 0, NULL, 0, 0, NULL, NULL},
...
const am_stringtable_t am_stringtab_color_names[] = {
    {LCD_COLOR_BLACK, "black"},   {LCD_COLOR_BLUE, "blue"},     {LCD_COLOR_GREEN, "green"},
    {LCD_COLOR_RED, "red"},       {LCD_COLOR_YELLOW, "yellow"}, {LCD_COLOR_CYAN, "cyan"},
    {LCD_COLOR_PURPLE, "purple"}, {LCD_COLOR_WHITE, "white"},   {0, NULL}};

const am_stringtable_t am_stringtab_255Auto[] = {
    {255, "auto"}, {0, NULL} // <- marks the end of a string table
};

const am_stringtable_t am_stringtab_narrator_modes[] = {{NARRATOR_MODE_OFF, "off"},
...
//---------------------------------------------------------------------------
void Menu_Open(app_menu_t*  pMenu,  // [in] menu instance data in RAM, NULL for "main menu instance"
               ...
               int   edit_mode)       // [in] new edit mode, e.g. APPMENU_EDIT_OFF. Negative: don't modify.
{
    ...
    if (cpJumpToItem != NULL) {
        ...
        for (i = 0; i < pMenu->num_items; ++i) {
            ...
            if (cp != NULL) { // Skip the "output formatting options" at the begin of the item text:
...
// Draws a "line of text with a menu item" into the framebuffer
{
        ...
        if (item_index >= 0 && item_index < pMenu->num_items) {
            ...
            if (editing &&
                ((pMenu->edit_mode == APPMENU_EDIT_INSERT) ||
                 (pMenu->edit_mode ==
                  APPMENU_EDIT_OVERWRT))) { // In these 'direct' editing modes, numbers are also edited AS STRINGS, so:
            ...
            if (editing &&
                ((pMenu->edit_mode == APPMENU_EDIT_OVERWRT) ||
                 (pMenu->edit_mode ==
                  APPMENU_EDIT_INSERT))) { // In edit modes 'OVERWRITE' or 'INSERT', use a single space as separator,
    ...
    LCD_FillRect(x, y, LCD_SCREEN_WIDTH - 1 /*x2*/, y + text_height_pixels - 1 /*y2*/, bg_color);
    ...
    if ((y > LCD_SCREEN_HEIGHT) &&
        (item_index == pMenu->item_index)) { // The 'guesstimate' in Menu_CheckVertScrollPos() was wrong,
...
//                0 when invisible (and someone else should 'draw').
{
    ...
    if (!(boot_flags &
          BOOT_FLAG_OPEN_FOR_BUSINESS)) { // Bail out if not all 'essential functions' have been called yet.
    ...
    if ((caller == AM_CALLER_F_4315_HOOK) && (global_addl_config.netmon != 0)) {
    ...
    if (pMenu->visible ==
        APPMENU_VISIBLE_UNTIL_KEY_RELEASED) { // Menu "almost closed" but still visible until releasing the last key.
    ...
    if (c) {
        ...
        if (pMenu->visible == APPMENU_USERSCREEN_VISIBLE) { // screen and keyboard occupied by a 'user screen' -> pass
                                                            // on keyboard events to it:
            y = Menu_InvokeCallback(pMenu, Menu_GetFocusedItem(pMenu), APPMENU_EVT_KEY, c);
            if (y !=
                AM_RESULT_OCCUPY_SCREEN) { // framebuffer no longer occupied by the callback, so back to the 'app menu':
                pMenu->visible = APPMENU_VISIBLE;
            ...
            if (((global_addl_config.keyb_mode == 1) &&
                ...
                ((global_addl_config.keyb_mode != 1) && ((pMenu->visible == APPMENU_VISIBLE) || (c == 'B')))) {
                switch (c) // using ASCII characters for simplicity
                {
                        ...
                        switch (pMenu->edit_mode) // ... or increment value when editing
                        {
                            ...
                            default: // not "editing" but "navigating" ...
                                if (pMenu->item_index > 0) {
                                    ...
                                    pMenu->morse_request =
                                        AMENU_MORSE_REQUEST_ITEM_TEXT | AMENU_MORSE_REQUEST_ITEM_VALUE;
                                } else {
                    ...
                    default: // Other keys .. editing or treat as a hotkey ?
                        ...
                        {
                            Menu_Open(pMenu, NULL, NULL,
                                      APPMENU_EDIT_OFF); // so open the ALTERNATIVE menu (default items)
                        }
                        if (pMenu->edit_mode != APPMENU_EDIT_OFF) {
                            Menu_ProcessEditKey(pMenu, c);
    ...
    if (pMenu->visible == APPMENU_VISIBLE) { // got here approx 9 times per second...

        // To keep the QRM radiated from the LCD cable low, only redraw the screen
        // if necessary, and with a LIMITED refresh rate.
        if (age_of_last_update > 20 /*ms*/) { // There may be items in the menu with 'dynamic' values,
        ...
        {
            if (ReadStopwatch_ms(&pMenu->stopwatch_late_redraw) >
                500 /*ms*/) { // guess the original firmware has updated what may be displayed now,
        ...
        if (pMenu->redraw) {                // LED_GREEN_ON; // for speed test (connect a scope to the green LED)
    ...
    if (global_addl_config.narrator_mode & NARRATOR_MODE_ENABLED) {
        if (ReadStopwatch_ms(&pMenu->morse_stopwatch) >
            500) { // ok, no further keyboard events for some time, so start sending NOW:
        ...
        if (pItem->callback) {
            ...
            switch (cbk_result) {
                case AM_RESULT_EXIT_AND_RELEASE_SCREEN:
                    ...
                    if (pMenu->visible == APPMENU_USERSCREEN_VISIBLE) { // the callback didn't switch back from 'user
                                                                        // screen' to 'menu screen'
        ...
        if ((pItem->data_type == DTYPE_SUBMENU) && (pItem->pvValue != NULL)) {
            ...
            if (pItem->options == APPMENU_OPT_BACK) {
                ...
                if ((pItem->options & APPMENU_OPT_EDITABLE) && MenuItem_HasValue(pItem)) {
                    if (pMenu->edit_mode != APPMENU_EDIT_OFF) { // was editing -> finish input ("write back")
...
{
    int cbk_result;
    if ((edit_mode != APPMENU_EDIT_OFF) && (pItem->options & APPMENU_OPT_EDITABLE) &&
        MenuItem_HasValue(pItem)) { // Copy the 'current' value into the internal storage,
...
void Menu_WriteBackEditedValue(app_menu_t* pMenu, menu_item_t* pItem) {
    ...
    if ((pMenu->edit_mode == APPMENU_EDIT_OVERWRT) ||
        (pMenu->edit_mode == APPMENU_EDIT_INSERT)) { // Parse pMenu->sz40EditBuf .. which format, decimal, hex, bin ?
        Menu_GetParamsFromItemText((char*)pItem->pszText, &num_base, &fixed_digits, NULL);
    ...
    if (i != 0) // .. but only if nonzero :
    {
        ...
        if (pItem->options & (APPMENU_OPT_BITMASK |
                              APPMENU_OPT_BITMASK_R)) { // Example: The "higher" backlight intensity, used when ACTIVE,
...
void Menu_OnIncDecEdit(app_menu_t* pMenu, int delta) {
    ...
    i = (int)i64;
    if (pMenu->iEditValue != i) { // report modified value in Morse code (VALUE only, not the leading text)
...
// Keyboard processing when the menu is in 'value editing mode'
{
    ...
    Menu_GetParamsFromItemText((char*)pItem->pszText, &num_base, &fixed_digits, NULL);
    if (pMenu->edit_mode == APPMENU_EDIT_INC_DEC) {
        if ((c >= '0' && c <= '9') || (c == '#')) { // Switch from 'inc/dec' editing mode to 'direct input':
    ...
    {                  // In "OVERWRITE" mode, the cursor appears like a selected character,
        ...
        i = pMenu->cursor_pos;
        if ((i > 0) && (i >= pMenu->edit_length)) { // cursor at the end of the string (where there's nothing to delete)
...
void Menu_AbortEditing(app_menu_t* pMenu, menu_item_t* pItem) {
    if (pMenu->edit_mode) {
        if (pMenu->iEditValue != pMenu->iValueBeforeEditing) { // value was modified .. need to "undo" this ?
...
// Exit/Back/Escape key pressed when the 'App Menu' was already open.
{
    int          cbk_result;
    menu_item_t* pItem = Menu_GetFocusedItem(pMenu);
    if (pItem) { // If the currently focused item has a callback function,
        // invoke that function to let the callback do whatever it wants:
...
BOOL Menu_ProcessHotkey(app_menu_t* pMenu, char c) {
    ...
    while (pItem->pszText != NULL) {
        if ((pItem->pszText[0] == '[') &&
            (pItem->pszText[1] == c)) { // Bingo, found an item with a matching hotkey (digit?) :
...
//---------------------------------------------------------------------------
int am_cbk_ColorTest(app_menu_t* pMenu, menu_item_t* pItem, int event,
                     int param) {   // Simple example for a 'user screen' opened from the application menu
...
int Menu_GetItemIndex(void) {     // used by the Morse narrator (narrator.c) to detect "changes"
    ...
    } else if (pMenu->visible ==
               APPMENU_USERSCREEN_VISIBLE) { // Currently showing a 'user' screen, e.g. the alternative ZONE list.
...
//---------------------------------------------------------------------------
void Menu_ReportItemInMorseCode(int morse_request) // [in] bitcombination of AM_MORSE_REQUEST_..
{                                                  // Called from ..
    ...
    if (pMenu->visible == APPMENU_VISIBLE) {
        ...
        if (pItem != NULL) {
            if ((pItem->pszText != NULL) // items WITHOUT a fixed text are rare but possible!
                && (morse_request & AMENU_MORSE_REQUEST_ITEM_TEXT)) { // Skip the "output formatting options" at the
                                                                      // begin of the item text:
            ...
            if (MenuItem_HasValue(pItem) && (morse_request & AMENU_MORSE_REQUEST_ITEM_VALUE)) {
                if (pMenu->edit_mode != APPMENU_EDIT_OFF) {
                    n = pMenu->iEditValue;
             ...
             APPMENU_USERSCREEN_VISIBLE) { // Currently showing one of the 'user' screens, including zone list, etc.
        // If the 'user screen' has assembled a string for Morse output, send it:
        if ((pMenu->sz40MorseTextFromFocusedLine[0] != 0) && (morse_request & AMENU_MORSE_REQUEST_ITEM_TEXT)) {
...
//---------------------------------------------------------------------------
BOOL Menu_CheckLongKeypressToActivateMorse(app_menu_t* pMenu) { // Checks for a 'very long' press of the red 'Back' key.
